...
namespace CtXamarin
{
    ...
    public class MainActivity : AppCompatActivity
    {
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            profileData.Add("Name", "Ct Xamarin");    // String
            profileData.Add("Identity", 1008);      // String or number
            profileData.Add("Email", "ctxamarin@gmail.com"); // Email address of the user
            profileData.Add("Phone", "+14155852234");   // Phone (with the country code, starting with +)
            profileData.Add("Gender", "F");             // Can be either M or F
